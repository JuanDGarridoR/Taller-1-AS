package com.universidad.transferencias_distribuidas.config;
...
@EnableJpaRepositories(
    basePackages = "com.universidad.transferencias_distribuidas.repository.internacional",
...
public class BancoInternacionalDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean internacionalEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.universidad.transferencias_distribuidas.model")
